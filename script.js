...
function setHumanMode() {
    ...
    if(playMode != "h") {
        ...
        humanButton.style.backgroundColor = "green";
        comButton.style.backgroundColor = "#00c635";
    } else {
        alert("You are already playing Human vs Human");
    }
}
...
function setComputerMode() {
    ...
    if(playMode != "c") {
        ...
        humanButton.style.backgroundColor = "#00c635";
        comButton.style.backgroundColor = "green";
    } else {
        alert("You are already playing Human vs Computer");
    }
}
...
function markLegalMoves(positions) {
    ...
    for(let position of positions) {
        ...
        dot.innerHTML = "x";
        dot.style.color="#ffff"
        dot.style.backgroundColor = "#8080806d";
